...
public struct EstimatedCostSliderView: View {
    ...
    public init(value: Binding<String?>, sliderDidGetCreated: ((MultiSlider) -> Void)? = nil, isRangeSlider: Bool = true, viewModel: EVIOMultisliderViewModel? = nil, didEndDrag: @escaping (MultiSlider) -> Void, onChange: @escaping (MultiSlider) -> Void) {
        self._value = value
