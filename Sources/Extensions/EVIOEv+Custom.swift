...
public extension EVIOEv {
    ...
    static var id3: EVIOEv {
        ...
        let ev: EVIOEv = EVIOEv(primaryEV: nil, status: nil, hasFleet: nil, usageNumber: nil, id: nil, evId: nil, otherInfo: nil, version: nil, model: "ID.3", imageContent: nil, licensePlate: nil, country: nil, brand: "Wolksvagen", fleet: nil, sessions: nil, listOfGroupDrivers: nil, listOfDrivers: nil, userID: nil, evType: nil, evInfo: evInfo, createdAt: nil, updatedAt: nil, v: nil, contractID: nil)
        return ev
    }
